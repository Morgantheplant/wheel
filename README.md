...
Note: This project was orignially written in boring old JS, but I ended up converting it to Typescript so this project would get a little more interest (all the cool kids use Typescript now). I ended up just using/extending React's types API so I wouldn't have to bother typing all the components directly.
